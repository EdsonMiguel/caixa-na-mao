                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <div
                          className={`w-3 h-3 rounded-full ${getStatusColor(pedido.status)}`}
                        ></div>
                      ...
                      <p className="text-sm text-gray-600 mb-2">
                        ...
                        {pedido.itens.reduce((total, item) => total + item.quantidade, 0) === 1
                          ? 'item'
                          : 'itens'}{' '}
                        • {formatarDataHora(pedido.dataHora)}
                      </p>
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        {pedido.dataPagamento && (
                          <span className="flex items-center gap-1">
                            <DollarSign size={12} />
                            Pago: {formatarDataHora(pedido.dataPagamento)} •{' '}
                            {pedido.metodoPagamento
                              ? getNomeMetodoPagamento(pedido.metodoPagamento)
                              : 'N/A'}
                          </span>
                        )}
                      </div>
